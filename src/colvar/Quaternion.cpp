...
q: QUATERNION ATOMS=protein
PRINT ARG=q STRIDE=100 FILE=COLVAR
\endplumedfile
...
// active methods:
        ...
        void Quaternion::registerKeywords(Keywords& keys) {
            ...
            keys.addFlag("QUATERNION_DEFAULT_OFF_FLAG",false,"flags that are by default not performed should be specified like this");
            keys.addFlag("QUATERNION_DEFAULT_ON_FLAG",true,"flags that are by default performed should be specified like this");
